      ...
      <div className="vision__container">
          ...
          <div className="vision__content">
            ...
            <div className="vision__group">
                ...
                <div className="vision__section">
                    <div><p>1.</p><p>พัฒนาและกำหนดทิศทางการให้บริการด้านสุขภาพ ครอบคลุมด้านส่งเสริมสุขภาพการป้องกันโรค การรักษาพยาบาลและฟื้นฟูสภาพ </p></div>
                    <div><p>2.</p><p>เป็นผู้นำและประสานความร่วมมือภาคีเครือข่ายในการจัดการระบบบริการสุขภาพ</p></div>
                    <div><p>3.</p><p>ประเมินและติดตามผล การพัฒนากระบวนการดูแลผู้ป่วยกลุ่มโรค รายโรค ติดตามกำกับตัวชี้วัดทางคลินิก</p></div>
                    <div><p>4.</p><p>พัฒนาศักยภาพบุคลากรด้านวิชาการ การรักษาพยาบาล</p></div>
                </div>
            </div>
            <div className="vision__group">
                <div className="vision__title">
                ...
                <div className="vision__section">
                  <p><b>M</b>: Mastery เป็นนายตนเอง</p>
                  <p><b>O</b>: Originality เร่งสร้างสิ่งใหม</p>
                  <p><b>P</b>: People center ใส่ใจประชาชน</p>  
                  <p><b>H</b>: Humility ถ่อมตนอ่อนน้อม</p>  
                </div>
            </div>
            <div className="vision__group">
                <div className="vision__title">
